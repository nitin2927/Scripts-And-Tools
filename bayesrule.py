...
class search():
    ...
    def __init__(self, name):
        ...
        self.area_actual = 0
        self.sailor_actual = [0, 0]  # As "local" coodrs within search area
    ...
    def draw_map(self, last_kwown):
        ...
        cv.putText(self.img, '+', (last_kwown),
    ...
    def sailor_final_location(self, num_search_areas):
        ...
        # Find the sailor coordinate with respect to any Search Area subarray.
        ...
        if area == 1:
            ...
            x = self.area_actual[0] + SA3_CORNERS[0]
            y = self.area_actual[1] + SA3_CORNERS[1]
            self.area_actual = 3
        return x, y
    ...
    def revise_target_probs(self):
        """Update area target probalitties based on search effectiveness."""
        demon = self.p1 * (1 - self.sep1) + self.p2 * (1 - self.sep2) \
            + self.p3 * (1 - self.sep3)
        self.p1 = self.p1 * (1 - self.sep1) / demon
        self.p2 = self.p2 * (1 - self.sep2) / demon
        self.p3 = self.p3 * (1 - self.sep3) / demon
...
def main():
    ...
    print("P1 = {:.3f}, P2 = {:.3f}, P3 = {:.3f}" .format(
    ...
    while True:
        ...
        print("\n Search {} Results 1 = {}" .format(
            search_num, result_1), file=sys.stderr)
        print("\n Search {} Results 2 = {}" .format(
            search_num, result_2), file=sys.stderr)
        print("\n Search {} Effectiveness (E):" .format(search_num,))
        print("E1 = {:.3f}, E2 = {:.3f}, E3 = {:.3f}" .format(
            app.sep1, app.sep2, app.sep3))

        if result_1 == 'Not Found' and result_2 == 'Not_Found':
            print("\n New Target Probalities (P) for search {}:" .format(
                search_num + 1))
            print("P1 = {:.3f}, P2 = {:.3f}, P3 = {:.3f}" .format(
                app.p1, app.p2, app.p3))
        else:
